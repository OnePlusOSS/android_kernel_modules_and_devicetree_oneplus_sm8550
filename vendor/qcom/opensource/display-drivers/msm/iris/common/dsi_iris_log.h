...
#ifndef IRIS_LOGE_IF
#define IRIS_LOGE_IF(cond, ...)	\
	IRIS_LOG_IF(cond, " E", __VA_ARGS__)
#endif

#ifndef IRIS_LOGW_IF
#define IRIS_LOGW_IF(cond, ...)	\
	IRIS_LOG_IF(iris_get_loglevel() > 0 && (cond), " W", __VA_ARGS__)
#endif

#ifndef IRIS_LOGI_IF
#define IRIS_LOGI_IF(cond, ...)	\
	IRIS_LOG_IF(iris_get_loglevel() > 1 && (cond), " I", __VA_ARGS__)
#endif

#ifndef IRIS_LOGD_IF
#define IRIS_LOGD_IF(cond, ...)	\
	IRIS_LOG_IF(iris_get_loglevel() > 2 && (cond), " D", __VA_ARGS__)
#endif

#ifndef IRIS_LOGV_IF
#define IRIS_LOGV_IF(cond, ...)	\
	IRIS_LOG_IF(iris_get_loglevel() > 3 && (cond), " V", __VA_ARGS__)
#endif

#ifndef IRIS_LOGVV_IF
#define IRIS_LOGVV_IF(cond, ...)	\
	IRIS_LOG_IF(iris_get_loglevel() > 4 && (cond), " VV", __VA_ARGS__)
#endif
