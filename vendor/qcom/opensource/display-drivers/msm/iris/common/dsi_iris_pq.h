...
extern bool iris_skip_dma;
extern u32 iris_min_color_temp;
extern u32 iris_max_color_temp;
extern u32 iris_min_x_value;
extern u32 iris_max_x_value;
extern uint8_t iris_pq_update_path;
extern bool m_dpp_precsc_enable;
extern u16 *iris_crstk_coef_buf;
extern u32 dwCSC2CoffBuffer[12];
...
void iris_set_edr_curve_ratio(u32 val);
