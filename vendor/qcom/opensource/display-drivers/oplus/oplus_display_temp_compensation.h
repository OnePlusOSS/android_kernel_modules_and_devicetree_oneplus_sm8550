...
enum oplus_temp_compensation_log_level {
	...
	OPLUS_TEMP_COMPENSATION_LOG_LEVEL_ERR,
	OPLUS_TEMP_COMPENSATION_LOG_LEVEL_WARN,
	OPLUS_TEMP_COMPENSATION_LOG_LEVEL_INFO,
	OPLUS_TEMP_COMPENSATION_LOG_LEVEL_DEBUG,
};
...
struct oplus_temp_compensation_params {
	...
	unsigned int reg_repeat;									/* reg repeat count, max 4, default 4 */
