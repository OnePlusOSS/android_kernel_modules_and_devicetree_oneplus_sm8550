...
//********************************************************************************
// Function Name 	: IOWrite32A_LC898128
//********************************************************************************
void IORead32A_LC898128( UINT_32 IOadrs, UINT_32 *IOdata )
{
...
// Function Name 	: IOWrite32A_LC898128
//********************************************************************************
void IOWrite32A_LC898128( UINT_32 IOadrs, UINT_32 IOdata )
{
	RamWrite32A( CMD_IO_ADR_ACCESS, IOadrs ) ;
...
//********************************************************************************
// Function Name 	: UnlockCodeSet_LC898128
//********************************************************************************
UINT_8 UnlockCodeSet_LC898128( void )
{
	UINT_32 UlReadVal, UlCnt=0;

	do {
		IOWrite32A_LC898128( 0xE07554, 0xAAAAAAAA );
		IOWrite32A_LC898128( 0xE07AA8, 0x55555555 );
		IORead32A_LC898128( 0xE07014, &UlReadVal );
...
//********************************************************************************
// Function Name 	: UnlockCodeClear_LC898128
//********************************************************************************
UINT_8 UnlockCodeClear_LC898128(void)
{
	UINT_32 UlDataVal, UlCnt=0;

	do {
		IOWrite32A_LC898128( 0xE07014, 0x00000010 );	
		IORead32A_LC898128( 0xE07014, &UlDataVal );
...
//********************************************************************************
// Function Name 	: WritePermission_LC898128
//********************************************************************************
void WritePermission_LC898128( void )
{
	IOWrite32A_LC898128( 0xE074CC, 0x00000001 );	
	IOWrite32A_LC898128( 0xE07664, 0x00000010 );	
}
...
{
	IOWrite32A_LC898128( 0xE07CCC, 0x0000ACD5 );	
}
//********************************************************************************
...
UINT_8 CoreResetwithoutMC128( void )
{
	...
	IOWrite32A_LC898128( 0xE07664, 0x00000010);
	IOWrite32A_LC898128( 0xE07CCC, 0x0000ACD5);
	IOWrite32A_LC898128( 0xE0700C, 0x00000000);
	IOWrite32A_LC898128( 0xE0701C, 0x00000000);
	IOWrite32A_LC898128( 0xE07010, 0x00000004);

	WitTim(100);

	IOWrite32A_LC898128( 0xE0701C, 0x00000002);
	IOWrite32A_LC898128( 0xE07014, 0x00000010);

	IOWrite32A_LC898128( 0xD00060, 0x00000001 ) ;
	WitTim( 15 ) ;

	IORead32A_LC898128( ROMINFO,				(UINT_32 *)&UlReadVal ) ;	
...
//********************************************************************************
// Function Name 	: FlashMultiRead_LC898128
//********************************************************************************
UINT_8	FlashMultiRead_LC898128( UINT_8 SelMat, UINT_32 UlAddress, UINT_32 *PulData , UINT_8 UcLength )
{
	UINT_8	i	 ;
	...
	IOWrite32A_LC898128( 0xE07008 , 0x00000000 | (UINT_32)(UcLength-1) );
	IOWrite32A_LC898128( 0xE0700C , ((UINT_32)SelMat << 16) | ( UlAddress & 0x00003FFF ) );
	
	IOWrite32A_LC898128( 0xE0701C , 0x00000000);
	IOWrite32A_LC898128( 0xE07010 , 0x00000001 );
	for( i=0 ; i < UcLength ; i++ ){
		IORead32A_LC898128( 0xE07000 , &PulData[i] ) ;
	}
...
//********************************************************************************
// Function Name 	: FlashBlockErase_LC898128
//********************************************************************************
UINT_8	FlashBlockErase_LC898128( UINT_8 SelMat , UINT_32 SetAddress )
{
	UINT_32	UlReadVal, UlCnt;
	UINT_8	ans	= 0 ;
	...
	ans	= UnlockCodeSet_LC898128();
	if( ans != 0 )	return( ans ) ;		

	WritePermission_LC898128();		
	if( SelMat != USER_MAT ){
		if( SelMat == INF_MAT2 )	IOWrite32A_LC898128( 0xE07CCC, 0x00006A4B );
		else						IOWrite32A_LC898128( 0xE07CCC, 0x0000C5AD );
	}
	AddtionalUnlockCodeSet();	
	
	IOWrite32A_LC898128( 0xE0700C , ((UINT_32)SelMat << 16) | ( SetAddress & 0x00003C00 )) ;

	IOWrite32A_LC898128( 0xE0701C , 0x00000000);
	IOWrite32A_LC898128( 0xE07010 , 4 ) ;
	...
	do {
		...
		IORead32A_LC898128( FLASHROM_FLAINT, &UlReadVal ) ;
	} while( ( UlReadVal & 0x00000080 ) != 0 ) ;

	IOWrite32A_LC898128( 0xE0701C , 0x00000002);
	ans	= UnlockCodeClear_LC898128();	
	if( ans != 0 )	return( ans ) ;	
...
UINT_8	FlashBlockWrite( UINT_8 SelMat , UINT_32 SetAddress , UINT_32 *PulData)
{
	...
	IOWrite32A_LC898128( 0xE0700C , ((UINT_32)SelMat << 16) | ( SetAddress & 0x000010 )) ;
	
	IOWrite32A_LC898128( 0xE0701C , 0x00000000);
	IOWrite32A_LC898128( 0xE07010 , 2 ) ;


	UlCnt	= 0 ;

	for( i=0 ; i< 16 ; i++ ){
		IOWrite32A_LC898128( 0xE07004 , PulData[i]  );
	}
	do {
		if( UlCnt++ > 100 ){	ans = 2;	break;	} ;

		IORead32A_LC898128( 0xE07018 , &UlReadVal ) ;
	} while( ( UlReadVal & 0x00000080 ) != 0 ) ;

	IOWrite32A_LC898128( 0xE07010 , 8  );	
...
UINT_8 Mat2ReWrite( void )
{
	...
	ans = FlashMultiRead_LC898128( INF_MAT2, 0, UlMAT2, 32 );
	if(ans)	return( 0xA0 );
	...
	ans = FlashBlockErase_LC898128( INF_MAT2 , 0 );
...
//
//--------------------------------------------------------------------------------
	if( UnlockCodeSet_LC898128() != 0 ) 		return (0x33) ;	
	WritePermission_LC898128();								
	AddtionalUnlockCodeSet();						
...
#endif
	if(ans != 0){
		if( UnlockCodeClear_LC898128() != 0 ) 	return (0x32) ;	
		else					 		return( ans );
	}

 	ans = ProgramFlash128_Standard( ptr );
	if(ans != 0){
		if( UnlockCodeClear_LC898128() != 0 ) 	return (0x43) ;	
		else					 		return( ans );
	}
...
//--------------------------------------------------------------------------------
	...
	IOWrite32A_LC898128( SYSDSP_REMAP,				0x00001000 ) ;	
	WitTim( 15 ) ;											
	IORead32A_LC898128( ROMINFO,				(UINT_32 *)&UlReadVal ) ;	
