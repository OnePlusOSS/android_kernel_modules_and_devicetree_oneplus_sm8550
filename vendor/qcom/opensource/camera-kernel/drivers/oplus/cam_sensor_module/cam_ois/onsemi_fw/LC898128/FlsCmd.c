...
//extern void IORead32A_LC898128( UINT_32 IOadrs, UINT_32 *IOdata );
...
UINT_32 CheckDrvOffAdj( void )
{
	...
	IORead32A_LC898128( FLASHROM_FLA_RDAT, &UlReadDrvOffaf ) ;  	// #13
	IORead32A_LC898128( FLASHROM_FLA_RDAT, &UlReadDrvOffx ) ;  	// #14
	IORead32A_LC898128( FLASHROM_FLA_RDAT, &UlReadDrvOffy ) ;	// #15
...
UINT_8	FlashSingleRead( UINT_8 SelMat, UINT_32 UlAddress, UINT_32 *PulData )
{
	...
	IORead32A_LC898128( FLASHROM_FLA_RDAT, PulData ) ;
	IOWrite32A( FLASHROM_FLAMODE , 0x00000002);
...
UINT_8	FlashMultiRead( UINT_8 SelMat, UINT_32 UlAddress, UINT_32 *PulData , UINT_8 UcLength )
{
	...
	for( i=0 ; i < UcLength ; i++ ){
		IORead32A_LC898128( FLASHROM_FLA_RDAT, &PulData[i] ) ;
