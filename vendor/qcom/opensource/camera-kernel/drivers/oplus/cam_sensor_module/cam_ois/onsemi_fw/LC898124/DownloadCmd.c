...
#endif
#if ((((SELECT_VENDOR&0x01) == 0x01) || ((SELECT_VENDOR&0x80) == 0x80)) && (SELECT_MODEL == 0x03))		// QTech or OnePlus
#include "LC898124EP3_Code_1_12_0_1_0.h"                  //oplus ICM-42631
#include "LC898124EP3_Code_12_0_1_3.h"                  // OnePlus BMI260
#endif
...
} else if(Dspcode->ActType == ACT_M10239) {
	TRACE("actuator type : M10239\n");
} else {
	TRACE("Error Act \n");
}
...
if(Dspcode->GyroType == GYRO_BMI260 )
TRACE("gyro type : Bosch BMI260 \n")	;
...
#endif
#if ((((SELECT_VENDOR&0x01) == 0x01) || ((SELECT_VENDOR&0x80) == 0x80)) && (SELECT_MODEL == 0x03))		// QTech or OnePlus
 {0x0000, 1, LC898124EP3_PM_1_12_0_1_0, LC898124EP3_PMSize_1_12_0_1_0, (UINT32)((UINT32)LC898124EP3_PMCheckSum_1_12_0_1_0 + (UINT32)LC898124EP3_DMA_CheckSum_1_12_0_1_0 + (UINT32)LC898124EP3_DMB_CheckSum_1_12_0_1_0), LC898124EP3_DM_1_12_0_1_0, LC898124EP3_DMA_ByteSize_1_12_0_1_0 , LC898124EP3_DMB_ByteSize_1_12_0_1_0 },
 {0x0003, 1, LC898124EP3_PM_12_0_1_3, LC898124EP3_PMSize_12_0_1_3, (UINT32)((UINT32)LC898124EP3_PMCheckSum_12_0_1_3 + (UINT32)LC898124EP3_DMA_CheckSum_12_0_1_3 + (UINT32)LC898124EP3_DMB_CheckSum_12_0_1_3), LC898124EP3_DM_12_0_1_3, LC898124EP3_DMA_ByteSize_12_0_1_3 , LC898124EP3_DMB_ByteSize_12_0_1_3 },
#endif
#if (((SELECT_VENDOR&0x02) == 0x02) || ((SELECT_VENDOR&0x80) == 0x80))			// OFILM or Oneplus
...
unsigned char SelectDownload(UINT8 GyroSelect, UINT8 ActSelect, UINT8 MasterSlave, UINT8 FWType)
{
	...
	if ((MasterSlave == 0x00) || (MasterSlave == 0x02) || (MasterSlave == 0x01)) {		//20190522 Komori
		ptr = ( DOWNLOAD_TBL *)DTbl124;
	}else{
		CAM_ERR(CAM_OIS, "SelectDownload found MasterSlave is invalid!\n");
		return(0xF0);
	}
