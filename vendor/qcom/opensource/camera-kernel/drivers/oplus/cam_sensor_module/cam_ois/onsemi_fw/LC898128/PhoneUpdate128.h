...
#ifndef PHONEUPDATE128_H_
#define PHONEUPDATE128_H_
...
// Prototype
//==============================================================================
extern UINT_8	FlashDownload128( UINT_8, UINT_8, UINT_8, UINT_8 );

//extern UINT_8	SetAngleCorrection( float , UINT_8 , UINT_8  );
extern UINT_8	UnlockCodeSet_LC898128( void );
extern UINT_8	UnlockCodeClear_LC898128(void);
