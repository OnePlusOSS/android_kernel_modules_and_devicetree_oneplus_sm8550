...
#define FT3681_REG_RESOLUTION_INFORMATION          0x96
#define FT3681_REG_TEMPERATURE                     0x97
#define FTS_REG_PALM_TO_SLEEP_STATUS               0x9B

#define FT3681_REG_WORK_MODE                       0x9E
#define FT3681_REG_WORK_MODE_SNR_MODE              0x81
#define FT3681_REG_WORK_MODE_FINAL_DIFF_MODE       0x01
#define FT3681_REG_WORK_MODE_NORMAL_MODE           0x00
...
#define FT3681_MAX_POINTS_SNR_LENGTH               1505 /* 2+6*10+4*10 + 2 + 2*tx*rx + (tx+rx)*2*2 + 1 + 40 */
#define FT3681_DIFF_BUF_LENGTH                     576 /* tx*rx */
#define FT3681_SC_BUF_LENGTH                       52 /* tx+rx */
...
#define FTS_180HZ_REPORT_RATE                   0x00
#define FTS_240HZ_REPORT_RATE                   0x01
#define FTS_360HZ_REPORT_RATE                   0x02
#define FTS_480HZ_REPORT_RATE                   0x03
...
struct chip_data_ft3681 {
	...
	u8 touch_buf[FT3681_MAX_POINTS_SNR_LENGTH];
	u8 irq_type;
	u8 touch_direction;
	u8 fp_en;
	u8 fp_down;
	...
	int diff_buf[FT3681_DIFF_BUF_LENGTH];
	int sc_water[FT3681_SC_BUF_LENGTH];
	int sc_nomal[FT3681_SC_BUF_LENGTH];
	int snr_count;
