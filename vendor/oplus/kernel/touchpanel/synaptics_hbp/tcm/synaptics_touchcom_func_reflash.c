		...
		struct tcm_buffer *rd_data, unsigned int rd_delay_us)
{
	...
	LOGD("BOOT_CONFIG : 0x%x, length: %d\n", addr, length);
		...
		struct tcm_buffer *rd_data, unsigned int rd_delay_us)
{
	...
	LOGD("DISP_CONFIG : 0x%x, length: %d\n", addr, length);
		...
		struct tcm_buffer *rd_data, unsigned int rd_delay_us)
{
	...
	LOGD("Custom data : 0x%x, length: %d\n", addr, length);
