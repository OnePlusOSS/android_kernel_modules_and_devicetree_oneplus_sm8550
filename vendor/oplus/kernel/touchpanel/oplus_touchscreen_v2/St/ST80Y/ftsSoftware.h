...
/* Report rate */
#define REPOTE_RATE_CMD1        0xC0
#define REPOTE_RATE_CMD2        0x0A
#define REPOTE_RATE_CMD3	0x11

/* First tap lock */
#define FIRST_TAP_LOCK_CMD1        0xC0
#define FIRST_TAP_LOCK_CMD2        0x10
#define FIRST_TAP_READ_CMD1        0xC1
#define FIRST_TAP_READ_CMD2        0x13
#define ST_MAX_IIR        		   0x0e
#define FIRST_TAP_LOCK_ENABLE      0X01
/*move tap lock*/
#define ST_TOL_X					4
#define ST_TOL_Y					4
#define ST_CHARGE_TOL_X				6
#define ST_CHARGE_TOL_Y				6


/* Scan frequency*/
#define SCAN_FREQUENCY_CMD1        0xA0
#define SCAN_FREQUENCY_CMD2        0x03


/* Water Mode*/
#define WATER_MODE_CMD1        0xC0
#define WATER_MODE_CMD2        0x04

/* Mp flag Mode*/
#define MP_FLAG_READ_CMD1        0xA4
#define MP_FLAG_READ_CMD2        0x06
#define MP_FLAG_READ_CMD3        0x01
#define MP_FLAG_READ_CMD4        0xA6
#define MP_FLAG_READ_CMD5        0x00
#define MP_FLAG_READ_CMD6        0x40
#define MP_FLAG_READ_CMD7        0x41

#define MP_FLAG_SET_CMD1        0xC0
#define MP_FLAG_SET_CMD2        0x0F

#define MP_FLAG_SAVE_CMD1        0xA4
#define MP_FLAG_SAVE_CMD2        0x05
#define MP_FLAG_SAVE_CMD3        0x04


/* Grip rejection mode */
#define GRIP_REJECT_CMD1        0xC0
#define GRIP_REJECT_CMD2        0x0C
