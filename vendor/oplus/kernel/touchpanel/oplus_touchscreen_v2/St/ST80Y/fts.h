...
struct bus_ops {
	...
	int (*fts_writeRead)(void *chip_data, u8 *cmd, int cmdLength, u8 *outBuf, int byteToRead);
	int (*fts_write)(void *chip_data, u8 *cmd, int cmdLength);
	int (*fts_writeFwCmd)(void *chip_data, u8 *cmd, int cmdLenght);
	int (*fts_writeThenWriteRead)(void *chip_data, u8 *writeCmd1, int writeCmdLength, u8 *readCmd1, int readCmdLength, u8 *outBuf, int byteToRead);
	int (*fts_writeU8UX)(void *chip_data, u8 cmd, AddrSize addrSize, u64 address, u8 *data, int dataSize);
	int (*fts_writeReadU8UX)(void *chip_data, u8 cmd, AddrSize addrSize, u64 address, u8 *outBuf, int byteToRead, int hasDummyByte);
	int (*fts_writeU8UXthenWriteU8UX)(void *chip_data, u8 cmd1, AddrSize addrSize1, u8 cmd2, AddrSize addrSize2, u64 address, u8 *data, int dataSize);
	int (*fts_writeU8UXthenWriteReadU8UX)(void *chip_data, u8 cmd1, AddrSize addrSize1, u8 cmd2,
