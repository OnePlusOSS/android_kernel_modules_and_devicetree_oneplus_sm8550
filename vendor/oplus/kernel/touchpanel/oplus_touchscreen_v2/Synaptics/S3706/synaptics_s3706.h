...
struct chip_data_s3706 {
	...
	/*synaptics func provide to synaptics common driver*/
	...
	/*show the default strong lock point level in high frequency*/
	uint8_t default_lock_point_level;
	/*show what if need do force update when touch up*/
