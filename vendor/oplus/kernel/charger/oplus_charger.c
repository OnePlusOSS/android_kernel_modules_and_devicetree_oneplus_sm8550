...
int oplus_chg_get_cool_down_status(void)
{
	...
	chg_err("ret = 0x%x, cool_down=%d,usbtemp_cool_down=%d, bcc_cool_down=%d, slow_chg_cool_down=%d\n", ret,
		chip->cool_down, chip->usbtemp_cool_down, chip->bcc_cool_down, slow_chg_cool_down);
