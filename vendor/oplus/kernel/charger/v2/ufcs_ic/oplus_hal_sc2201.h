...
#define SC2201_VENDOR_ID 0x0006
...
#define SC2201_CMD_DPDM_EN                  (0x89)
...
#define SC2201_MASK_DP_VH             	(0x6B)

/*reg02F1*/
#define SC2201_ADDR_UFCS_RXTX_HARDRESET_TIME    (0x02F1)
#define SC2201_FLAG_RXTX_HARDRESET_TIME_MASK    (BIT(3) | BIT(2))
