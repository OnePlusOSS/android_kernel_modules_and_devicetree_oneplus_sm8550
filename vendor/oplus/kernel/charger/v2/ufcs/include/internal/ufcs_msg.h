...
#define UFCS_TEST_EQQUEST_ENABLE_TEST_MODE(data)		(((data) >> 15) & 0x1)
#define UFCS_TEST_EQQUEST_ENABLE_VOL_ACC_TEST_MODE(data)	(((data) >> 14) & 0x1)
#define UFCS_TEST_EQQUEST_DEV_ADDR(data)			(((data) >> 11) & 0x7)
#define UFCS_TEST_EQQUEST_MSG_TYPE(data)			(((data) >> 8) & 0x7)
#define UFCS_TEST_EQQUEST_MSG_CMD(data)				((data) & 0xf)
#define UFCS_TEST_EQQUEST_DATA(test_mode, vol_acc_test_mode, dev_addr, msg_type, msg_cmd)		\
