...
{
	/* req/cnf ids */
	NETLINK_REQUEST_HBA_ESTABLISH = 100,
	...
	/* req ids, no cnf */
	NETLINK_REQUEST_HBA_DELETE = 200,

	/* ind ids */
	NETLINK_UNSOL_HBA_PAUSE = 300,
	NETLINK_UNSOL_HBA_TIMEOUT,

	__HBA_NETLINK_MSG_MAX = 400,
};

enum
{
	HBA_NETLINK_CMD_UNSPEC,
	HBA_NETLINK_CMD_DOWNLINK,
	HBA_NETLINK_CMD_UPLINK,
	__HBA_NETLINK_CMD_MAX
};
