...
#if LINUX_VERSION_CODE > KERNEL_VERSION(5, 15, 0)
static struct kmsg_dump_iter wb_kmsg_dumper;
#else
static struct kmsg_dumper    wb_kmsg_dumper;
#endif
