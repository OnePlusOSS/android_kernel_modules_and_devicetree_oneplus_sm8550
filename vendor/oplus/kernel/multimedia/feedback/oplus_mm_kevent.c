...
static struct nla_policy mm_fb_genl_policy[MM_FB_CMD_ATTR_MAX + 1] = {
	[MM_FB_CMD_ATTR_MSG] = { .type = NLA_NUL_STRING },
	[MM_FB_CMD_ATTR_OPT] = { .type = NLA_U32 },
};
