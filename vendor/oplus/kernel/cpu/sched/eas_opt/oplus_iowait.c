		...
		size_t count, loff_t *ppos)
{
	...
	len = snprintf(buffer, sizeof(buffer), "iowait_boost_freq_enabled=%u\n", sysctl_oplus_iowait_boost_enabled);
...
static const struct proc_ops proc_iowait_reset_fops = {
	.proc_write = proc_iowait_reset_write,
	.proc_read = proc_iowait_reset_read,
	.proc_lseek = default_llseek,
};

static const struct proc_ops proc_iowait_apply_fops = {
	.proc_write = proc_iowait_apply_write,
	.proc_read = proc_iowait_apply_read,
	.proc_lseek = default_llseek,
};

static const struct proc_ops proc_iowait_boost_enabled_fops = {
	.proc_write = proc_iowait_boost_enabled_write,
	.proc_read = proc_iowait_boost_enabled_read,
	.proc_lseek = default_llseek,
};

static const struct proc_ops proc_iowait_skip_min_fops = {
	.proc_write = proc_iowait_skip_min_write,
	.proc_read = proc_iowait_skip_min_read,
	.proc_lseek = default_llseek,
};
