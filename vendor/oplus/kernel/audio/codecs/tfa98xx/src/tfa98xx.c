...
{
	struct snd_soc_component *codec = dai->codec;
	struct tfa98xx *tfa98xx = snd_soc_component_get_drvdata(codec);
	unsigned int sr;
...
{
	struct tfa98xx *tfa98xx = snd_soc_component_get_drvdata(codec_dai->codec);
...
{
	struct tfa98xx *tfa98xx = snd_soc_component_get_drvdata(dai->codec);
	struct snd_soc_component *codec = dai->codec;
