...
#ifndef _SIA8152_REGS_H
#define _SIA8152_REGS_H

#define SIA8152_REG_CHIP_ID				(0x00)
#define SIA8152_REG_MOD_CFG				(0x01)
#define SIA8152_REG_SYS_EN				(0x02)
#define SIA8152_REG_OVP_CFG				(0x03)
#define SIA8152_REG_OPC_HCFG			(0x04)
#define SIA8152_REG_TEST_CFG			(0x05)
